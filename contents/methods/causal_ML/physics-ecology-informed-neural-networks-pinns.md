---
layout: method
title: "Physics/ecology informed neural networks (PINNs)"
parent: "Causal ML"
date: 2025-07-17
author: Mrs. Young
---
...
{: .note }
This method also belongs to [Counterfactual & future simulations]({ site.url }/simulations/) and [Ecology-guided Modelling]({ site.url }/ecology-guided/).
{% endif %}
