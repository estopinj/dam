...
3. From your study design: If units are truly isolated, mark `Required`; if only minor spillover possible, `Recommended`; if you expect substantial interference and/or want to specifically study the impact of relaxing this assumption, `Relaxes assumption`. 
...
- Your 1 km² forest plots are >50 km apart (birds don’t travel far) → `Required`. If plots are 5 km apart (some movement), Recommended. If there is a continuous landscape with high connectivity, you pick a spatial model that relaxes no‐interference. 
